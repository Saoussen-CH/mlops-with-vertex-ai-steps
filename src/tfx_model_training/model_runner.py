...
#from tfx_model_training import defaults
#from tfx_model_training import model_trainer
#from src.model_training import exporter
import defaults
...
def run_fn(fn_args: tfx.components.FnArgs):
    ...
    hyperparameters = defaults.update_hyperparams(hyperparameters)
